...
public class RlspFoodVersionMediaType {
    ...
    public static final String V1_APPLICATION_JSON_VALUE = "application/vnd.rlspfood.v1+hal+json";
    public static final String V2_APPLICATION_JSON_VALUE = "application/vnd.rlspfood.v2+hal+json";
